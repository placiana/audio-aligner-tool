...
window.translations = {
    en: {
        ...
        recent_preview: "Contents Preview",
        empty_repo_preview: "📭 Repository is empty. Click to upload files!",
        total_files: "Files",
        total_folders: "Folders",
        storage_used: "Storage",
        new_folder: "📁 New Folder",
        upload_files: "📤 Upload Files",
        drop_files_here: "Drop files here to upload to current directory",
        th_name: "Name",
        th_size: "Size",
        th_modified: "Modified",
        th_actions: "Actions",
        empty_repo: "This folder is empty",
        empty_repo_sub: "Upload files or create folders using the buttons above.",
        ...
        upload_source_local: "💻 Local PC",
        upload_source_repo: "📁 From Repository",
        select_repo_audio_btn: "📁 Choose Audio from Repository",
        select_repo_text_btn: "📁 Choose Text from Repository",
        repo_picker_title: "📁 Choose File from Repository",
        export_dropdown_btn: "Export ▾",
        csv_btn: "CSV (.csv)",
    ...
    es: {
        ...
        google_login_btn: "Continuar con Google",
        ...
        recent_preview: "Vista previa del contenido",
        empty_repo_preview: "📭 El repositorio está vacío. ¡Haz clic para subir archivos!",
        total_files: "Archivos",
        total_folders: "Carpetas",
        storage_used: "Espacio",
        new_folder: "📁 Nueva Carpeta",
        upload_files: "📤 Subir Archivos",
        drop_files_here: "Arrastra archivos aquí para subirlos a la carpeta actual",
        th_name: "Nombre",
        th_size: "Tamaño",
        th_modified: "Modificado",
        th_actions: "Acciones",
        empty_repo: "Esta carpeta está vacía",
        empty_repo_sub: "Sube archivos o crea carpetas usando los botones superiores.",
        folder_name_label: "Nombre de la Carpeta",
        rename_item: "✏️ Renombrar Elemento",
        new_name_label: "Nuevo Nombre",
        cancel_btn: "Cancelar",
        create_btn: "Crear",
        delete_confirm: "¿Estás seguro de que deseas eliminar este elemento?",
        upload_source_local: "💻 Desde Equipo",
        upload_source_repo: "📁 Del Repositorio",
        select_repo_audio_btn: "📁 Elegir Audio del Repositorio",
        select_repo_text_btn: "📁 Elegir Texto del Repositorio",
        repo_picker_title: "📁 Elegir Archivo del Repositorio",
        export_dropdown_btn: "Exportar ▾",
        csv_btn: "CSV (.csv)",
